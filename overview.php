<?php 
  ...
  if(!$user){ 
    header("Location: ./login.php?nexturl=overview.php?$_SERVER[QUERY_STRING]"); 
    exit; 
  }
...
<html lang="en" dir="ltr">
  ...
  <body>
              ...
              <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <a class="dropdown-item" href="./overview.php?logout='1'">
              ...
              <div class="col-lg-3 ml-auto">
                <form class="input-icon my-3 my-lg-0">
                  <div class="row gutters-xs">
                    <div class="col">
                      <input type="text" class="form-control" placeholder="Search for responses from user...">
                    </div>
                    <span class="col-auto">
                        ...
                        <?php
                          if (isset($_GET['name'])&&isset($_GET['id'])) {
                            ...
                            if (in_array($project_id, $project_ids, true)&&in_array($project_name, $project_names, true)) {
                              ...
                              $results = mysqli_query($db, $query);
                              $collaborators_arr = mysqli_fetch_row($results);
                              foreach ($collaborators_arr as $key => $collaborator) {
                                  if (empty($collaborator)) {
                                      unset($collaborators_arr[$key]);
                                  }
                              }
                              if (!empty($collaborators_arr)) {
                                  $collaborators = explode(",",implode(",",$collaborators_arr));
                      ...
                      <strong>
                        <?php
                          if (isset($_GET['name'])&&isset($_GET['id'])) {
                            ...
                            if (in_array($project_id, $project_ids, true)&&in_array($project_name, $project_names, true)) {
                              $query = "SELECT mobile_devices FROM projects WHERE project_name='$project_name' LIMIT 1";
                              $results = mysqli_query($db, $query);
                              $devices = implode(",",mysqli_fetch_row($results));
                              echo $devices;
                            }
                          }
                        ?>
    ...
    <script>
      require(['chart', 'jquery', 'moment'], function(Chart, $, moment){
        $(function() {
          ...
          function displayData(r,d) {
            ...
            responseChart = new Chart(ctx, {
              ...
              options: {
                ...
                title: {
                  display: true,
                  text: `Total responses collected for the ${d}`
                }
              }
            });

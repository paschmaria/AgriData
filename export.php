          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-3 col-md-4">
                ...
                <div>
                  <div class="mt-6 mb-6">
                    <a href="./reports.php<?php echo isset($_GET['id']) ? '?name='.e($_GET['name']).'&id='.e($_GET['id']) : null ?>" class="btn btn-secondary btn-block">
                      <span class="icon mr-3"><i class="fe fe-download-cloud"></i></span>Generate PDF Report
                    </a>
                  </div>
                  <div class="mt-6 mb-6">
                    <a href="./export.php<?php echo isset($_GET['id']) ? '?name='.e($_GET['name']).'&id='.e($_GET['id']) : null ?>" class="btn btn-secondary btn-block active">
